...
function prependerModified(account) {
    ...
    if (account.validAccount) {
        plan = !account.accountInfo.expiredPremiumUser && parseInt(account.accountInfo.premium_redirect_cookie);
        twoStepVerification = !!account.accountInfo.twoStepVerification;
